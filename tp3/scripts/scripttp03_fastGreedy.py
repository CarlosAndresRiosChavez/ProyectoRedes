...
outputFile= open("./scripttp03_fastGreedy_communities.txt", "w")
...
nx.draw_networkx_nodes(G3, pos, nodelist=node_list_community0, node_color='c', node_size= 80)
nx.draw_networkx_nodes(G3, pos, nodelist=node_list_community1, node_color='r', node_size= 80)
nx.draw_networkx_nodes(G3, pos, nodelist=node_list_community2, node_color='b', node_size= 80)
